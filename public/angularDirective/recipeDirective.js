...
angular.module('nourriture').directive('commentPage', function ($timeout) {
    return{
        replace:true,
        scope:{
            page : '=pageObject',
...
angular.module('nourriture').directive('productPage', function ($timeout) {
    return{
        replace:true,
        scope:{
            page : '=pageObject',
...
angular.module('nourriture').directive('otherrecipesPage', function ($timeout) {
    return{
        replace:true,
        scope:{
            page : '=pageObject',
...
angular.module('nourriture').directive('ownrecipesPage', function ($timeout) {
    return{
        replace:true,
        scope:{
            page : '=pageObject',
